...
//     var requist = await fetch('http://localhost:5148/api/Cart/CreateNewCartItem', {
//         method: 'POST',
//         headers: {
...
//     ;
//     if (!isUserLoggedIn()) {
//         window.location.href = 'login&register.html'; // Redirect to login if user isn't logged in
//     } else {
