...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=DESKTOP-SNJ0164;Database=Masterpiece\n;Trusted_Connection=True;TrustServerCertificate=True;");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Admin>(entity =>
        {
            entity.HasKey(e => e.AdminId).HasName("PK__Admin__43AA4141F3F7BA0F");
        ...
        {
            entity.HasKey(e => e.CartItemId).HasName("PK__Cart_Ite__3C0E2A44732F8CBB");
        ...
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__Category__D54EE9B47512623A");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__ChatMess__3214EC07FC47AAA2");
        ...
        {
            entity.HasKey(e => e.CommentId).HasName("PK__Comment__E7957687B4972B67");
        ...
        {
            entity.HasKey(e => e.ContactId).HasName("PK__Contact__024E7A8692F70A30");
        ...
        {
            entity.HasKey(e => e.CoponId).HasName("PK__Copons__8A47306F200B50C5");
        ...
        {
            entity.HasKey(e => e.OrderId).HasName("PK__Orders__465962298822D74C");
        ...
        {
            entity.HasKey(e => e.OrderItemId).HasName("PK__Order_It__483A64F9006FBA91");
        ...
        {
            entity.HasKey(e => e.ProductId).HasName("PK__Products__47027DF5387FDCC0");
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__Users__B9BE370FC865E6E3");
